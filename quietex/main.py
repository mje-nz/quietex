...
def run_command(cmd: List[str], **kwargs):
    ...
    # TODO: use pexpect.fdexpect and treat stdout and stderr separately
    # https://stackoverflow.com/questions/27179383/extracting-stderr-from-pexpect
    # or:
